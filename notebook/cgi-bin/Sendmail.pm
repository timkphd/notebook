...
%mailcfg = (
    ...
    'debug'   => 1 # prints stuff to STDERR
);
...
Copy Sendmail.pm to Mail/ in your Perl lib directory.
    ...
    (eg. c:\Perl\site\lib\Mail\ or /usr/lib/perl5/site_perl/Mail/, 
	 ... or whatever it is on your system. They are listed when
	 you type C< perl -V >)
...
Last revision: 24.08.2002. Latest version should be available on
