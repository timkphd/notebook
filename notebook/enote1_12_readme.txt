E-Note version 1.12 changes Readme
----------------------------------
...
enote.pl file be adapted to your needs, but existing enote.pl 
...
* Printing
  ...
  $main::print_wd = 38;
  - which is in the provided enote.pl file.
...
* Subscription
  ...
  - which are in the provided enote.pl file.
  ...
  >enote.pl
  (or if the enote.pl is not marked as executable, >perl enote.pl)
